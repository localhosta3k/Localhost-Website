...
const CaseTwo = () => {
  ...
  const Four =
    "https://gratech.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcase-two-image3.3a76ba45.jpg&w=384&q=75";
  const Five =
    "https://gratech.vercel.app/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Fcase-two-image4.e42aa37b.jpg&w=384&q=75";
  return (
          ...
          >
              ...
              <div className="swiper-slide">
                <div className="case-two__item">
                  <div className="image case-two__image">
                    <Image width={370} height={420} src={Two} alt="Image" />
                  </div>
            ...
            <SwiperSlide>
              <div className="swiper-slide">
                <div className="case-two__item">
                  <div className="image case-two__image">
                    <Image width={370} height={420} src={Three} alt="Image" />
                  </div>
                  <div className="case-two__content">
            ...
            <SwiperSlide>
              <div className="swiper-slide">
                <div className="case-two__item">
                  <div className="image case-two__image">
                    <Image width={370} height={420} src={Four} alt="Image" />
                  </div>
                  <div className="case-two__content">
                    <span>Technology</span>
                    <h4>
            ...
            <SwiperSlide>
              <div className="swiper-slide">
                <div className="case-two__item">
                  <div className="image case-two__image">
                    <Image width={370} height={420} src={Five} alt="Image" />
                  </div>
                  <div className="case-two__content">
                    <span>Technology</span>
                    <h4>
